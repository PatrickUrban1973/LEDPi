...
{
    [LEDModule(LEDModules.Maze)]
    public class LEDMazeModule : ModuleBase
    {
        ...
        public LEDMazeModule(ModuleConfiguration moduleConfiguration) : base(moduleConfiguration, 1f, 10)
        {
        }
